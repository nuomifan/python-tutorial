...
command1 = {'关机': 'shutdown -s -t 100',
             '重启': 'shutdown -r -t 100',
             '关闭浏览器': 'taskkill /F /IM chrome.exe',
             'google一下': r'C:\Program Files (x86)\Google\Chrome\Application\chrome.exe',
             '关闭QQ': 'taskkill /F /IM QQ.exe',
             '关闭wifi': 'taskkill /F /IM kwifi.exe',
             '关闭音乐': 'taskkill /F /IM cloudmusic.exe',
             '打开音乐': r"D:\Program Files (x86)\Tencent\QQMusic\QQMusic.exe",
             '放首歌': r"D:\Program Files (x86)\Tencent\QQMusic\QQMusic.exe",
             # '打开摄像头': 'D:\\Python源码\\摄像头监控.py',
             # '打开监控': 'D:\\Python源码\\winSpyon.py',
             '打开QQ': r"D:\Program Files (x86)\Tencent\QQ\Bin\QQScLauncher.exe",
